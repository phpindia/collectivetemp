...
import { Grid, Row, Col, Table, Button, ButtonToolbar, Badge, ButtonGroup} from "react-bootstrap";
    ...
    return (
      <div className="content">
        ...
        <Grid fluid>
          <Row>
            <Col md={12}>
            <button className="btn btn-fill btn-info"><Link to={{ pathname: '/AddPoll'}} ><font color="white">Create New Poll</font></Link></button>
              <Card
                title="Polls"
